...
export const DEFAULT_PACKAGES: PackageRecord[] = [
  {
    ...
    features: ["1 live room", "3 camera phones", "R2 logo assets", "External overlay link"],
    id: "starter-live",
    max_cameras: 3,
    max_rooms: 1,
    name: "Starter Live",
  ...
  },
  {
    ...
    features: ["2 live rooms", "5 camera phones", "Sponsor graphics", "Ad/promo mode"],
    id: "matchday-pro",
    max_cameras: 5,
    max_rooms: 2,
    name: "Matchday Pro",
  ...
  },
  {
    ...
    features: ["5 live rooms", "8 camera phones", "Priority admin review", "Team branding controls"],
    id: "season-ops",
    max_cameras: 8,
    max_rooms: 5,
    name: "Season Ops",
